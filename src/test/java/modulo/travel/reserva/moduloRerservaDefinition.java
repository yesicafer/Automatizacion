...
@Steps
	...
	@Given("^con dos adultos(\\d+)$")
	public void con_dos_adultos(int arg1)  {
	reservaSteps.con_dos_adultos(arg1);    
	}


	@Given("^cero niños(\\d+)$")
	public void cero_niños(int arg1) {
	reservaSteps.cero_niños(arg1);
	}
